...
modules_commun = ["islamic","tamazight"]
modules_spe = ["german","electric","spanish","g_civil","g_mecanique","g_procedes","gestion","economy"]
fields = ["sci", "le", "lp","m","lit","mt","se","ge"]
year = 2020
